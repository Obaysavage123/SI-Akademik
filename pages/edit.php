        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Edit Nilai</a></li>
...
<?php 
	include "../koneksi.php";
	$id = $_GET['id'];
	$query_mysql = mysqli_query($koneksi,"SELECT * FROM kkmm WHERE id_mata_pelajaran='$id'")or die(mysql_error());
	$nomor = 1;
	...
	<form action="update.php" method="post">		
        ...
        <input type="hidden" name="id" value="<?php echo $data['id_mata_pelajaran'] ?>">
				<td><input type="text" name="mapel" value="<?php echo $data['mata_pelajaran'] ?>"></td>					
			</tr>	
			<tr>
				<td>KKM</td>
