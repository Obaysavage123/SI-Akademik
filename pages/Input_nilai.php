...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../wali_kelas.php" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                  <a href="../wali_kelas.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Nilai Harian, PTS Dan PAS </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Input Nilai</a></li>
              <li class="breadcrumb-item active">Nilai Harian,PTS Dan PAS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<button style="float:right;margin-right:10px;" type="button" class="btn btn-success btna">Tambahkan Nilai</button>

  <footer class="main-footer">
    <div class="float-right d-none d-sm-block">
    </div>
    <strong>Copyright &copy;2019 <a href="http://adminlte.io">SIAPORT</a>.</strong>
  </footer>
